...
//v #define DSTIKE_DEAUTHER_OLED_V3
...
//#define SH1106_I2C
 ...
 // #define BUTTON_A 13
  ...
  #define BUTTON_A D3     // D4
  #define BUTTON_B D4     // D3
...
// #define SSD1306_I2C
  ...
  #define I2C_SDA 4
  #define I2C_SCL 5
  #define BUTTON_UP D6   // D5
  #define BUTTON_DOWN D5 // D6
...
#elif defined(NODEMCU) || defined(WEMOS_D1_MINI) || defined(DSTIKE_USB_DEAUTHER) || defined(DSTIKE_NODEMCU_07) || defined(DSTIKE_DEAUTHER_V1) || defined(DSTIKE_DEAUTHER_V2) || defined(DSTIKE_DEAUTHER_V3)
// ===== LED ===== //
 #define LED_NEOPIXEL_GRB
 #define LED_NUM 1
 #define LED_NEOPIXEL_PIN D8
